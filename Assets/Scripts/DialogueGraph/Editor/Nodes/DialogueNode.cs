...
namespace DialogueGraph.Editor.Nodes
{
    ...
    class DialogueNode : DialogueGraphNode
    {
        ...
        public const string OPTION_DIALOGUE_NAME = "Dialogue";

        protected override void OnDefineOptions(IOptionDefinitionContext context)
        {
            context.AddOption<string>(OPTION_DIALOGUE_NAME)
            .WithTooltip("Type your dialogue here")
            .Build();
        }
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            context.AddInputPort<DialogueLocation>(IN_PORT_DIALOGUE_LOCATION_NAME)
                .WithDefaultValue(DialogueLocation.Bottom)
                .Build();
